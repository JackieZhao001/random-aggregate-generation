...
load 'cyl_0929_1.mat'
%
eloc=importdata('Elemloc_cyl_40.txt');
% 
O2(k:num_2,:)=[];
O1(kk:num_1,:)=[];
...
fid = fopen('E:\Work_file\Matlab\1_Mine\Guliao_new\D0_ematA.txt','wt');
fprintf(fid,'%d\n',emat32);
fclose(fid);
fid = fopen('E:\Work_file\Matlab\1_Mine\Guliao_new\D0_ematC.txt','wt');
fprintf(fid,'%d\n',emat0);
fclose(fid);
fid = fopen('E:\Work_file\Matlab\1_Mine\Guliao_new\D0_ematITZ.txt','wt');
fprintf(fid,'%d\n',emat2);
fclose(fid);
